...
**Status: proposed (2026-07-01); Phases 0–3 executed 2026-07-02 (2.3 deferred
behind spec 0007 Phase 5).** Companion to
...
## Phase 0 — decisions and docs (hours, no code) — ✅ DONE 2026-07-02

**0.1 Fold command sourcing into Replication §7.** ✅ (folded as "The durable
form of this channel"; `command_sourcing_todo.md` deleted; Storage.md section
shrunk to a pointer.)
...
**0.2 Decide the mixed-origin sibling-set rule.** ✅ (Replication §5 + §10.)
...
**0.3 Document the file-syncer contract (invariant 11).** ✅ (README "Vault
directory & third-party file sync" + Sync.md vault-contract note.)
