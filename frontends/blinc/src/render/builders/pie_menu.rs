...
use super::operation_helpers::find_ops_affecting;
use super::operation_helpers::get_entity_name;
...
/// When Blinc gets proper context menu support, this will use
/// ContextMenuBuilder.
pub fn build(args: &ResolvedArgs, ctx: &RenderContext) -> Div {
    ...
    // Build a simple operation list on click (context menu when overlay support
    // exists)
