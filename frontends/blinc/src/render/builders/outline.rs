...
/// outline(parent_id:parent_id, sortkey:sort_key, item_template:(render_block
/// this))
///
/// Renders data as an indented hierarchical list using parent-child
/// relationships. Now delegates to `shared_tree_build` — same logic as `tree`.
