...
use holon_api::DataRowAccumulator;
...
/// Ply-specific render context wrapping the shared RenderContext with Ply
/// extensions.
#[derive(Clone)]
...
impl RenderContext {
    ...
    /// Get block data (render expr + rows) via services, ensuring a watcher is
    /// running.
