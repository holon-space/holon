...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/desktop_webview_window/desktop_webview_window.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/macos_secure_bookmarks/macos_secure_bookmarks.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/rust_lib_holon/rust_lib_holon.framework"
