...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `Batch`, `Change`, `WatchHandle`, `WatcherCommand`, `WithMetadata`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_fields_are_eq`, `assert_fields_are_eq`, `assert_fields_are_eq`, `assert_fields_are_eq`, `assert_fields_are_eq`, `assert_fields_are_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `deref_mut`, `deref`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from`, `hash`
...
// These functions are ignored (category: IgnoreBecauseOwnerTyShouldIgnore): `into_parts`, `new`, `recv`, `set_variant`, `try_recv`
...
class CollectionId {
  ...
  const CollectionId({required this.field0});
...
sealed class UiEvent with _$UiEvent {
  ...
  const factory UiEvent.structure({
    required WidgetSpec widgetSpec,
    required BigInt generation,
  }) = UiEvent_Structure;

  /// CDC deltas for the active query.
  /// `generation` matches the Structure that created the matview.
  const factory UiEvent.data({
    required BatchMapChangeWithMetadata batch,
    required BigInt generation,
  }) = UiEvent_Data;
  ...
  const factory UiEvent.collectionUpdate({
