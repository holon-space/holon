...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `FilterExpr`, `Operation`, `RenderSpec`, `RenderableItem`, `RowTemplate`, `ViewSpec`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `assert_receiver_is_total_eq`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `from_str`, `hash`
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `get_root_mut`, `new`, `root`, `table`
...
class RowProfile {
  ...
  @override
  int get hashCode => name.hashCode ^ render.hashCode ^ operations.hashCode;
