...
// These types are ignored because they are neither used by any `pub` functions nor (for structs and enums) marked `#[frb(unignore)]`: `FilterExpr`, `Operation`, `RenderableItem`, `RowProfile`, `RowTemplate`, `ViewSpec`
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `new`, `to_rhai`, `visible_columns`
...
class OperationDescriptor {
  ...
  Future<OperationWiring> toDefaultWiring() => RustLib.instance.api
      .holonApiRenderTypesOperationDescriptorToDefaultWiring(that: this);
...
class OperationWiring {
  ...
  @override
  int get hashCode => modifiedParam.hashCode ^ descriptor.hashCode;
