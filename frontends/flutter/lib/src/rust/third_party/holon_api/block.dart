...
// These function are ignored because they are on traits that is not defined in current crate (put an empty `#[frb]` on it to unignore): `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `clone`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `eq`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `fmt`, `try_from`
// These functions are ignored (category: IgnoreBecauseExplicitAttribute): `as_source`, `as_text`, `content_text`, `depth_from`, `entity_schema`, `from_entity`, `get_header_arg`, `get_property_str`, `get_property`, `get_source_header_args`, `get_source_results`, `is_prql_block`, `is_source_block`, `metadata`, `properties_map`, `schema`, `set_block_content`, `set_metadata`, `set_properties_map`, `set_source_header_args`, `set_source_results`, `short_name`, `title`, `to_block_content`, `to_entity`, `to_plain_text`
// These functions have error during generation (see debug logs or enable `stop_on_error: true` for more details): `error`, `new_source`, `new_text`, `new`, `set_property`, `source`, `text`, `text`, `with_header_arg`, `with_name`
