...
class MainScreen extends HookConsumerWidget {
    ...
    useEffect(() {
      Future(() async {
        try {
          ...
          isRightDrawerOpen.value = await ffi.isWidgetOpen(blockId: _rightSidebarKey);
        } catch (_) {}
      });
      return null;
    }, const []);
                                ...
                                children: [
                                  ...
                                  IconButton(
                                    ...
                                    onPressed: () {
                                      ...
                                      _saveWidgetOpen(_rightSidebarKey, isRightDrawerOpen.value);
                                    },
                                    padding: EdgeInsets.zero,
                                    constraints: BoxConstraints(
                                      minWidth: TitleBarDimensions.hamburgerButtonSize,
  ...
  /// Builds the main body content based on navigation state.
  ///
  /// Two cases:
  /// 1. Viewing a document - show DocumentViewWidget
  /// 2. Root layout - show BlockRefWidget with watch_ui (auto error recovery)
  Widget _buildBodyContent(
    ...
    // Case 1: Viewing a specific document (full-width, no sidebar)
    ...
    // Case 2: Root layout via BlockRefWidget with watch_ui
    // BlockRefWidget handles loading, errors, and structural recovery automatically.
    final backendService = ref.read(backendServiceProvider);
    final screenContext = RenderContext(
      colors: colors,
      isScreenLayout: true,
