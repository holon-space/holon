...
//!
//! This module re-exports opaque types and defines enums for proper Dart
//! pattern matching.
...
/// Trace context for propagating OpenTelemetry trace information across FFI
/// boundary.
///
...
impl TraceContext {
    ...
    ///
    /// Delegates to BatchTraceContext::from_span_context for consistent
    /// handling.
