    ...
    group('Binary Operations', () {
      ...
      testWidgets('evaluates logical: completed and visible', (tester) async {
        final contextWithVisible = RenderContext(
          resolvedRow: ResolvedRow(data: {
            ...context.valueData,
            'visible': const Value.boolean(true),
          }),
        );
      ...
      testWidgets('renders text with named argument', (tester) async {
        final expr = RenderExpr.functionCall(
          ...
          args: [
            Arg(
              name: 'value',
              value: const RenderExpr.literal(value: Value.string('Named Text')),
            ),
          ],
          operations: const [],
        );
            ...
            Arg(
              ...
              value: RenderExpr.functionCall(
                ...
                args: [
                  Arg(
                    name: null,
                    value: const RenderExpr.literal(value: Value.string('Child 1')),
                  ),
                ],
                operations: const [],
              ),
            ...
            Arg(
              ...
              value: RenderExpr.functionCall(
                ...
                args: [
                  Arg(
                    name: null,
                    value: const RenderExpr.literal(value: Value.string('Child 2')),
                  ),
                ],
                operations: const [],
              ),
            ...
            Arg(
              ...
              value: RenderExpr.functionCall(
                ...
                args: [
                  Arg(
                    name: null,
                    value: const RenderExpr.literal(value: Value.string('Indented')),
                  ),
                ],
                operations: const [],
              ),
            ...
            Arg(
              ...
              value: RenderExpr.functionCall(
                ...
                args: [
                  Arg(
                    name: null,
                    value: const RenderExpr.literal(value: Value.string('Item 1')),
                  ),
                ],
                operations: const [],
              ),
            ...
            Arg(
              ...
              value: RenderExpr.functionCall(
                ...
                args: [
                  Arg(
                    name: null,
                    value: const RenderExpr.literal(value: Value.string('Item 2')),
                  ),
                ],
                operations: const [],
              ),
