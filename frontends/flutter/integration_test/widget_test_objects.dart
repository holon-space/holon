...
class EditableTextWidgetObject extends WidgetTestObject {
  ...
  Future<bool> Function(WidgetTester tester)? handler(
    ...
    return (WidgetTester tester) async {
      // IDs contain entity scheme (e.g. "block:block-0") — matches ValueKey set by render_block_builder
...
final List<WidgetTestObject> widgetTestObjects = [
  EditableTextWidgetObject(),
];
