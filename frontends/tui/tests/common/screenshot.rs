...
//! Reusing the existing analyzer means inv-frontend-engine fires identically
//! across GPUI and TUI without changing trait surfaces.
//!
...
use holon_integration_tests::ui_driver::CapturedScreenshot;
use holon_integration_tests::ui_driver::ScreenshotBackend;
