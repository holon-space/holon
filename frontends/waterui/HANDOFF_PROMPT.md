...
- **14 builders implemented**: text, row, list, columns, section, spacer, icon, live_query, render_block, block_ref, clickable, editable_text, table, tree
...
- **Operations module**: `dispatch_operation` works for clickable actions but editable_text doesn't dispatch `set_field` on edit
