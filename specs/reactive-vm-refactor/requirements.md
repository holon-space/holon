...
- [ ] AC-1.1.4: `layout_pbt::layout_invariants_hold_for_random_scenarios` passes (exercises mode switches)
...
- [ ] AC-3.3.3: `layout_pbt` passes — layout containers render correctly with the split
...
- [ ] AC-4.1.4: `layout_pbt::block_ref_inside_tree_item_has_nonzero_height` passes (exercises expand state)
...
- [ ] AC-4.2.4: `layout_pbt::layout_invariants_hold_for_random_scenarios` passes (exercises mode switches)
