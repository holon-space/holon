...
//! ## What "PASS" means
//!
//! - The Loro JSON round-trip preserves `Value::Array` losslessly. This means:
//!   zero changes to `read_properties_from_meta` / `write_properties_to_meta`
//!   are required for the spike.
//! - `block_to_params` flows the array into params as-is. This means: zero
//!   changes to `loro_sync_controller.rs` (diff_snapshots_to_ops,
//!   block_diff_params, blocks_differ) are required.
