//! Reproducer for Turso IVM "Mismatch in number of registers" panic using
//! existing DB
//!
...
//! /tmp/turso-ivm-repro-prod-copy.db
//!
//!   cargo run --example turso_ivm_register_mismatch_existing_db_repro
//!
//! Known Turso IVM bugs this may trigger:
//! 1. "Mismatch in number of registers! Got 30, expected 26"
//!    (expr_compiler.rs:378)
