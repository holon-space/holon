...
use holon_api::clock::{CalendarDate, Clock, Grain};
...
mod tests {
    ...
    /// millis for local-noon on the given date — timezone-robust (noon UTC lands
    /// on the same civil date from UTC-12 to UTC+12).
