    ...
    injector.provide::<BackendEngine>(
        Provider::root_async(move |inj| {
            ...
            async move {
                ...
                .instrument(tracing::info_span!("di.resolve_schema_roots"))
                .await;

                let backend = inj.resolve::<RwLock<TursoBackend>>().clone();
                let dispatcher = async { inj.resolve_async::<OperationDispatcher>().await }
                    .instrument(tracing::info_span!("di.resolve_dispatcher"))
                    .await;
            ...
            .instrument(tracing::info_span!("di.factory.BackendEngine"))
        })
