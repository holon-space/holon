...
//! It centralizes dependency wiring and makes it easier to test and configure
//! services.
//!
//! Submodules:
...
pub use registration::register_core_services_no_turso;
pub use registration::register_core_services_with_backend;
pub use runtime::DbHandleCacheFactory;
pub use runtime::create_queryable_cache_async;
pub use schema_providers::DbReady;
pub use schema_providers::DbResource;
...
/// or data sync starts. This eliminates the "database is locked" bug that
/// occurs when `query_and_watch` tries to CREATE MATERIALIZED VIEW while IVM is
/// busy processing incoming data.
///
