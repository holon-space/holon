...
/// Assert two ViewModel trees match structurally, with a nice error message on
/// failure.
...
/// inv-frontend-no-error-widgets to surface the actual error messages without
/// needing to dump the full ViewModel.
