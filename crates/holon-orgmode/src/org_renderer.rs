...
impl OrgRenderer {
    ...
    pub fn render_blocks(blocks: &[Block], file_path: &Path, file_id: &EntityUri) -> String {
...
mod tests {
    ...
    fn test_render_simple_block() {
        ...
        let org_text = OrgRenderer::render_blocks(&[block], file_path, &test_doc_uri());
    ...
    fn test_source_blocks_render_before_child_headlines() {
        ...
        let org_text = OrgRenderer::render_blocks(&blocks, file_path, &test_doc_uri());
