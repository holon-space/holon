...
//!
//! - `shared_tree_build` (eager, hierarchical) — applied `rules:` but skipped
//!   profile/ops resolution.
...
//!   hierarchical) — resolved profile/ops via `row_render_context` but had no
//!   `rules:` support.
//!
