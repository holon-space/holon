...
use crate::editor_view_model::{structural_block_action, EditorKey};
...
impl HeadlessEditorMirror {
    ...
    fn slash_command_on_enter(
        ...
        use crate::input_trigger::{check_triggers, default_triggers_for_operations, ViewEvent};
        use crate::popup_menu::{PopupProvider, PopupResult};
