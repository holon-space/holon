    ...
    fn add_frontend(
        ...
        self.provide::<FrontendSession>(Provider::root_async(move |resolver| {
            ...
            async move {
                ...
                .instrument(tracing::info_span!(
                    "di.factory.FrontendSession.cache_subscriber"
                ))
                .await;
                tracing::info!(
                ...
                async { subscribe_filesystem_caches(&resolver).await }
                    .instrument(tracing::info_span!("di.factory.FrontendSession.fs_caches"))
                    .await;
                ...
                let ready_signal: Option<
                    holon_orgmode::di::FileWatcherReadySignal,
                > = resolver
