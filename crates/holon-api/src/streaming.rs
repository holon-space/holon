...
/// Type alias for Change<ResolvedRow>
///
/// Used for streaming query result changes to Flutter.
/// Each Created/Updated event carries a ResolvedRow with optional profile.
/// flutter_rust_bridge:non_opaque
pub type MapChange = Change<crate::widget_spec::ResolvedRow>;
