//! Shared attribute parsing helpers using syn AST instead of string
//! manipulation.
...
/// A single key = "value" pair in an attribute, e.g. `name = "block"`
struct KeyValue {
    key: Ident,
    value: AttrValue,
}
...
/// Parsed `#[reference(EntityName)]` or `#[reference(EntityName, edge =
/// "EDGE_NAME")]`
