...
//! 3. Calls the same MCP tool independently with first-page args for a
//!    sanity comparison (first-page count, reported total when present).
...
use holon_mcp_client::{connect_mcp, connect_mcp_child};
