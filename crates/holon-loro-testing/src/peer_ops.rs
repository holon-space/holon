...
//!   `holon_pbt_core::content_generators::peer_content_strategy`. `pos_codepoint`
//!   is caller-supplied: whether insert/delete positions ever hit 0 / len /
//!   mid-multibyte-cluster boundaries depends entirely on the PeerEdit
//!   generator upstream, not this file.
//!
