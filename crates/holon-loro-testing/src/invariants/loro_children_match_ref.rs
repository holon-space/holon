...
//! ordering encoding is adapter-internal and never compared byte-for-byte across
//! adapters; instead each adapter must agree with the reference on the *order*
//! its internal encoding produces.
