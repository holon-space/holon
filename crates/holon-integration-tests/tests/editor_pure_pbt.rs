...
//!
//! @pbt kind harness
//! @pbt covers editor-transition-sharing — proves migrated editor transitions are SHARED with WideE2E, not duplicated
//! @pbt overlaps general_e2e_composed_pbt — kept as fast storage-free editor fuzz + sharing proof
