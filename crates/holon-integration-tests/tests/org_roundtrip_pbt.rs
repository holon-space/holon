...
//! - structural equality is `NormalizedDocument` + `assert_normalized_docs_equal`.
//!
...
use holon_api::{Block, EntityUri, TaskState};
use holon_block_roundtrip_testing::{
    HeadlineSpec, NormalizedDocument, PropertiesDrawer, assert_normalized_docs_equal, build_blocks,
