...
impl StubSut {
    ...
    /// (Re)start the `LoroSyncController`. Used by `Restart` and
    /// `OfflineMerge`.
...
impl OperationProvider for StubOperationProvider {
    ...
    async fn execute_operation(
        ...
        panic!(
            "StubOperationProvider::execute_operation is not implemented; use \
...
impl OriginTaggedWrites for StubOperationProvider {
    async fn execute_operation_with_origin(
        ...
        panic!(
            "StubOperationProvider::execute_operation_with_origin is not implemented; use \
             execute_batch_with_origin"
        );
    }
