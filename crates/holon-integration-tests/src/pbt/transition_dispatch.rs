...
pub trait E2ETransitionFactory: Sized {
    ...
    /// `(weight, generator)` for the proptest aggregator. `None`
...
pub trait SutHandle {
    ...
    /// Post-startup: blur the active editor.
    ...
    (
        ...
        ::declarative_enum_dispatch::enum_dispatch!(
            ...
            pub trait E2ETransitionImpl: Clone + std::fmt::Debug + Send + Sync {
                fn preconditions(&self, state: &$crate::pbt::reference_state::ReferenceState) -> bool;
