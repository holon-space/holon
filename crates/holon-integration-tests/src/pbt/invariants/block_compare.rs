...
/// Shared order comparator, lifted to `holon-pbt-core` (co-location Phase 1) and
/// re-exported here so the historical `block_compare::compare_sibling_order`
/// path stays valid for central callers.
