...
//! reference-model bug (the matview is correct); base≠matview is a genuine
//! Turso IVM drift. (Historically this was hardcoded as "real Turso IVM bug" —
//! an unjustified leap, since a faithful matview over a wrong base looks
//! identical to drift unless you check the base.)
