...
fn index_org_content(
    ...
    let doc_uri = EntityUri::file("index.org");
    ...
    OrgRenderer::render_blocks(
        &blocks,
        Path::new("/index.org"),
        &EntityUri::file("index.org"),
    )
}
...
pub fn generate_org_file_content_with_keywords(
    ...
    let regular_file = (
        ...
        .prop_map(move |(filename, headings)| {
            ...
            let blocks: Vec<Block> = headings
                ...
                .collect();
            let rendered = OrgRenderer::render_blocks(
                &blocks,
                Path::new(&filename),
                &EntityUri::file(&filename),
            );
    ...
    let file_with_profile = (
        ...
        .prop_map(|(filename, headline, id, yaml)| {
            ...
            let content = OrgRenderer::render_blocks(
                &blocks,
                Path::new(&filename),
                &EntityUri::file(&filename),
            );
