//! Selection tests for `inv-loro-children-match-ref` — the invariant BODY + `wire()` now live
//! in the `holon-loro-testing` companion crate (co-location Phase 1) and reach
//! the composed catalog via the central fold. These fixture-driven
