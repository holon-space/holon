...
//! RefBlockTree`: the renderer supplies the widget tree; `RefBlockTree` supplies
//! the `Main`-region focus roots. Selected by any slice with a renderer — the
//! frontend slice's real headless `ReactiveEngine`.

use holon_pbt_core::RunMode;
use holon_pbt_core::capabilities::{RefBlockTree, SutRenderer};
