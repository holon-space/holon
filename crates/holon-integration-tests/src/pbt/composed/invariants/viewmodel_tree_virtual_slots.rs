...
//! slots are well-formed. `Needs SutRenderer` only (no reference): a
//! SUT-internal structural property. Selected by any slice with a renderer —
//! the frontend slice's real headless `ReactiveEngine`.
