...
//! @pbt covers all-slices — memoises ONE SUT's own reads within a single tick so
//!   co-scheduled invariants see a consistent snapshot; not a cross-SUT source.
//!
...
use crate::capabilities::EntityUri;
use crate::capabilities::FrontendRootVm;
use crate::capabilities::ProviderStabilityReport;
use crate::capabilities::RenderedElement;
use crate::capabilities::SutBackend;
use crate::capabilities::SutErrorLog;
use crate::capabilities::SutFocus;
use crate::capabilities::SutFrontendEmissions;
use crate::capabilities::SutFrontendEngine;
use crate::capabilities::SutLayout;
use crate::capabilities::SutLoroLog;
use crate::capabilities::SutOrgRead;
use crate::capabilities::SutOrgRender;
use crate::capabilities::SutRenderer;
use crate::capabilities::SutSqlProjection;
use crate::capabilities::SutViewSelection;
use crate::capabilities::SutWatch;
use crate::capabilities::ViewportHint;
use crate::capabilities::WatchRow;
use crate::capabilities::WidgetSnapshot;
