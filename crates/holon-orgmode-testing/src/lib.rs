...
//! (Phase 1a Step 0) so companion `*-testing` crates (e.g. `holon-loro-testing`)
//! can normalize blocks for cross-store comparison without depending on the
//! integration-tests crate. Phase 3 grows this into the org subsystem's full
//! companion crate.
