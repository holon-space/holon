//! Hypothesis: We can extract a subtree from a LoroDoc via fork -> delete
//! non-subtree nodes -> export, and the resulting doc contains usable history
//! of the subtree.
    ...
    for i in 0..100 {
        ...
        for j in 0..10 {
            ...
            set_text(
                ...
                block,
                &format!(
                    "Block {i}.{j}: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed \
