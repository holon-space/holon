//! Example 3: `declarative_enum_dispatch` — declarative dispatch.
//!
//! `enum_dispatch!` generates the trait, enum, and `impl Trait for Enum`
//! in one declarative macro call. IDE-friendly (unlike `enum_dispatch`).
//!
...
//!
//! One line added to the enum. Dispatch is automatic.
