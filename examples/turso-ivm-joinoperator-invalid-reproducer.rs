...
//! 4. The JoinOperator for the JOIN view is in Invalid state (never received
//!    updates)
//!
...
async fn main() -> anyhow::Result<()> {
    ...
    // - The JoinOperator for current_focus is in Invalid state because it never
    //   received any updates (events doesn't affect it)
    // =====================================================================
