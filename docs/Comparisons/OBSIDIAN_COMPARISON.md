...
**Holon:** Org journal files via FileSyncController. Render DSL for output templating.
...
| Format Converter | FileSyncController handles org→SQL; no general converter |
