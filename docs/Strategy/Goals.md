...
This document describes what Rusty Knowledge aims to achieve. It focuses on the "what" and "why" from a user perspective, not the "how" (see `docs/Architecture/Principles.md` for that).

For the implementation roadmap, see `docs/Vision.md`.
...
- `docs/Architecture/Principles.md` - How the system is built
- `docs/Vision.md` - Detailed roadmap and trade-offs
