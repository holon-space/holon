...
**The story:** You spent more time refining docs/Vision/PetriNet.md, BusinessAnalysis.md, SWOT.md, FeasibilityTodoistWedge.md, and PreMortem.md than writing code. The documents became increasingly elaborate and self-referencing. The gap between vision and implementation grew. The intellectual satisfaction of the design replaced the satisfaction of shipping.
...
**Counter-measures:**
- **Freeze vision documents.** No more edits until the wedge has 10 active users. This document (PreMortem.md) is the last strategy document for now.
...
- Keyboard-first: the Which-Key navigation system described in docs/Vision/UI.md is a differentiator for power users. Ship it early.
...
- [BusinessAnalysis.md](BusinessAnalysis.md) — Strategic analysis, competitive positioning, go-to-market
- [SWOT.md](SWOT.md) — SWOT matrix
- [docs/Vision.md](docs/Vision.md) — Technical vision and phased roadmap
- [docs/Vision/PetriNet.md](docs/Vision/PetriNet.md) — Petri Net + Digital Twin model
- [docs/Vision/AI.md](docs/Vision/AI.md) — AI roles and Trust Ladder
- [FeasibilityTodoistWedge.md](FeasibilityTodoistWedge.md) — Todoist browser overlay exploration
