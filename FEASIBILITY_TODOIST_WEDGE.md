...
*2026-02-21 — Phase 1 wedge exploration (see [BUSINESS_ANALYSIS.md](BUSINESS_ANALYSIS.md))*
...
- [BUSINESS_ANALYSIS.md](BUSINESS_ANALYSIS.md) — Wedge strategy and go-to-market phases
- [VISION_PETRI_NET.md](VISION_PETRI_NET.md) — Petri Net model that WSJF scoring feeds into
