...
From `docs/PARSE_DONT_VALIDATE_AUDIT.md` and `CLAUDE.md`: make illegal states unrepresentable. Parse raw data into typed representations at entry points, never re-validate at call sites.
