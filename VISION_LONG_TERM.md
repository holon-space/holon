...
The Integrator's primary interaction is **confirmation-driven edge creation**: it proposes links, the user confirms or rejects at System 1 speed (1-2 seconds). Each confirmed edge makes the graph denser without adding nodes, and denser graphs produce better future proposals — a compounding flywheel. See [VISION_AI.md](VISION_AI.md) §The Integrator.
